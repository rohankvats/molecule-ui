...
```jsx
// import { Pane, Text } from 'cereal-ui'
...
```jsx
// import { Pane, Button, Text, Heading } from 'cereal-ui'
...
```jsx
// import { Pane, Button, TextInput } from 'cereal-ui'
...
```jsx
// import { majorScale, Button } from 'cereal-ui'
...
```jsx
// import { minorScale, Button } from 'cereal-ui'
