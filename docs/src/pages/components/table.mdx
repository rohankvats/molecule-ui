...
MolecularUI exports a set of building blocks for building tables.
...
MolecularUI exports the following components for tables:
...
Virtual tables in MolecularUI are easy to create.
MolecularUI gives some nice features when working with virtual tables:
